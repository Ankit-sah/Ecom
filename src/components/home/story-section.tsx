    ...
    <section className="mx-auto grid max-w-6xl gap-6 px-4 sm:gap-8 md:gap-10 md:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
      <FadeIn className="h-full">
        <div className="flex h-full flex-col justify-between space-y-4 rounded-2xl border border-orange-200/60 bg-white p-6 shadow-sm transition hover:shadow-md sm:rounded-[32px] sm:space-y-5 sm:p-8 md:p-10">
          <div className="space-y-5">
            <p className="text-xs font-bold uppercase tracking-[0.35em] text-text-orange-600">
              Our Story
            </p>
            <h2 className="text-2xl font-bold tracking-tight text-text-gray-800 sm:text-3xl md:text-4xl">
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            {["Established 1993", "Family-led collective", "Exporting worldwide"].map((text) => (
              <span
                key={text}
                className="rounded-full border border-border-orange-200 bg-bg-orange-50 px-4 py-2 text-xs font-bold uppercase tracking-wide text-text-orange-600"
              >
                {text}
              </span>
            ))}
      ...
      <FadeIn delay={0.2} className="h-full">
        <div className="flex h-full flex-col justify-center gap-5 rounded-2xl border border-orange-200/60 bg-white p-6 shadow-sm transition hover:shadow-md sm:rounded-[32px] sm:gap-6 sm:p-8 md:p-10">
          <h3 className="text-xl font-bold text-text-gray-800 sm:text-2xl">
            Commitment to quality
          </h3>
          <ul className="space-y-5 text-sm text-neutral-700 sm:space-y-6 sm:text-base">
            <li className="flex gap-4">
              <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-full bg-[text-bg-orange-500]" />
              <div>
                <span className="block font-bold text-text-bg-orange-500">Generational craftsmanship</span>
            ...
            <li className="flex gap-4">
              <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-full bg-[text-bg-orange-500]" />
              <div>
                <span className="block font-bold text-text-bg-orange-500">Ethical sourcing</span>
            ...
            <li className="flex gap-4">
              <div className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-full bg-[text-bg-orange-500]" />
              <div>
                <span className="block font-bold text-text-bg-orange-500">Global trust</span>
