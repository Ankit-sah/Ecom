...
export type OrderStatusHistoryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "orderId" | "status" | "note" | "actorId" | "createdAt", ExtArgs["result"]["orderStatusHistory"]>
...
export interface OrderStatusHistoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more OrderStatusHistories that matches the filter.
   * @param {OrderStatusHistoryFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const orderStatusHistory = await prisma.orderStatusHistory.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.OrderStatusHistoryFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a OrderStatusHistory.
   * @param {OrderStatusHistoryAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const orderStatusHistory = await prisma.orderStatusHistory.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.OrderStatusHistoryAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
/**
 * OrderStatusHistory findRaw
 */
export type OrderStatusHistoryFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * OrderStatusHistory aggregateRaw
 */
export type OrderStatusHistoryAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
