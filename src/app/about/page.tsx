    ...
    <div className="mx-auto max-w-4xl space-y-8 px-4 py-8 sm:space-y-10 sm:px-4 sm:py-12 md:space-y-12 md:py-16">
      ...
      <section className="space-y-6">
        <div className="space-y-3">
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-orange-600">Our Heritage</p>
          <h1 className="text-2xl font-semibold text-gray-800 sm:text-3xl md:text-4xl">Rooted in Janakpur&apos;s cultural renaissance</h1>
        </div>
      ...
      <section className="rounded-3xl border border-orange-200/70 bg-white/85 p-8 shadow-sm">
        <h2 className="text-xl font-semibold text-gray-800 sm:text-2xl">Our Values</h2>
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="space-y-2">
            <h3 className="font-semibold text-orange-500">Generational Craftsmanship</h3>
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-orange-500">Ethical Sourcing</h3>
            <p className="text-sm text-neutral-700">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-orange-500">Global Trust</h3>
            <p className="text-sm text-neutral-700">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-orange-500">Cultural Preservation</h3>
            <p className="text-sm text-neutral-700">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-800 sm:text-2xl">Our Journey</h2>
        <div className="space-y-4 text-sm text-neutral-700">
          <div className="flex gap-4">
            <span className="font-semibold text-orange-500">1993</span>
            <p>Founded by Ajit Kumar Sah in Shankhamul, Kathmandu, with a vision to promote Mithila art globally.</p>
          </div>
          <div className="flex gap-4">
            <span className="font-semibold text-orange-500">2000s</span>
            <p>
          ...
          <div className="flex gap-4">
            <span className="font-semibold text-orange-500">2010s</span>
            <p>
              Launched international export programs, bringing Mithila artistry to galleries and collectors worldwide.
            </p>
          </div>
          <div className="flex gap-4">
            <span className="font-semibold text-orange-500">Today</span>
            <p>
      ...
      <section className="rounded-3xl border border-orange-500/50 bg-[text-bg-orange-500] p-8 text-white">
        <h2 className="text-xl font-semibold sm:text-2xl">Join Our Mission</h2>
        ...
        <div className="mt-6">
          <Link
            href="/products"
            className="inline-block rounded-full bg-white px-6 py-3 text-sm font-semibold text-orange-500 transition hover:bg-rose-50"
          >
